...
namespace WebAPI.Controllers
{
    ...
    public class ApplicationStudentsController : ControllerBase
    {
        ...
        [HttpPost("Add")]
        [ValidateModel(typeof(CreateApplicationStudentRequestValidator))]
        ...
        [HttpDelete("Delete")]
        public async Task<IActionResult> Delete([FromQuery] DeleteApplicationStudentRequest deleteApplicationStudentRequest)
        {
