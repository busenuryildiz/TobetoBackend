...
namespace WebAPI.Controllers
{
    ...
    public class EducationInformationsController : ControllerBase
    {
        ...
        [HttpPost("Add")]
        [ValidateModel(typeof(CreateEducationInformationRequestValidator))]
        ...
        [HttpDelete("Delete")]
        public async Task<IActionResult> Delete([FromQuery] DeleteEducationInformationRequest deleteEducationInformationRequest)
        {
